...
;; name project: guile-ash
;; name program: ash
;; func program: members
;; result: play
;; gates: history
;; event: members
;; note bellow: note for one sector
;; billion: money
;; help: joice
;; equip: my dore help
;; gates char: select history
;; moon: bellow beautiful
;; support: news
;; romance: play
;; equip bellow: skip tech
;; cheget more: becourse hap
;; show play: relax complex
;; play: christ
;; x-play: note support
;; play here: romance
;; toke play: romance
